...
footer = "<a href='https://github.com/khushi-purwar/Pencil-Sketcher-App-using-ML/blob/master/pencilsketch.py' style='margin-top:100px'>Click Here</a> to view the source code"
